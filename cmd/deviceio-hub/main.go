...
var (
	...
	startDBHost             = startCommand.Flag("db-host", "The rethinkdb client host to connect to").Default("localhost").String()
	...
	startAPIBind            = startCommand.Flag("api-bind", "The hostname or ip address to bind the http api to").Default("localhost").String()
	...
	startGatewayBind        = startCommand.Flag("gateway-bind", "The hostname or ip address to bind the gateway to").Default("localhost").String()
